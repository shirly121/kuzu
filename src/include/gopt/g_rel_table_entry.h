...
namespace catalog {
    ...
    public:
        ...
        GRelTableCatalogEntry(std::string name, common::RelMultiplicity srcMultiplicity,
            common::RelMultiplicity dstMultiplicity, common::table_id_t tableId, common::table_id_t labelId, common::table_id_t srcTableID,
            ...
            : RelTableCatalogEntry(std::move(name), srcMultiplicity, dstMultiplicity, 
                                   srcTableID, dstTableID, storageDirection), labelId(labelId) {
            this->setOID(tableId);
        }
        
        common::table_id_t getLabelId() {
            return this->labelId;
        }
