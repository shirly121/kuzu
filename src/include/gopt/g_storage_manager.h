...
public : GStorageManager(const std::string& statsPath,
                                const catalog::Catalog& catalog, MemoryManager& memoryManager, kuzu::storage::WAL &wal)
